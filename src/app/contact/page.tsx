...
export const metadata: Metadata = {
  title:'Contact Us',
  description: 'Connect with us for exceptional content. Reach out via LinkedIn, Email, Reporting, or Suggestions. Your input matters!',
  keywords: 'contact us, get in touch, reach out, LinkedIn, email, reporting, suggestions, customer service, inquiries, feedback',
};
